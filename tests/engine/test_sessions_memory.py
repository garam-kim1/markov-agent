...
async def test_rewind_functionality():
    ...
    with (
        ...
        controller = ADKController(config, retry)
        await controller.rewind(session_id="session_123", user_id="user_456", rewind_before_invocation_id="inv_789")
...
async def test_add_session_to_memory():
    ...
    with (
        ...
        await controller.add_session_to_memory(session_id="session_123", user_id="user_456")

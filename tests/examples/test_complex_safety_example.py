...
from examples.callbacks.complex_safety import PIIScrubCallback, PolicyCheckCallback, CallbackException
...
def test_policy_check_callback():
    ...
    safe_response.candidates[0].content.parts = [MockPart(text="This is a safe response.")]
    ...
    unsafe_response.candidates[0].content.parts = [MockPart(text="Here is the unspeakable_secret info.")]
    
    with pytest.raises(CallbackException) as excinfo:
